...
<template>
  <footer id="footer" class="p-4">
	  <div class="text-right sm:max-w-sm max-w-full ms-auto" style="grid-area:subscribe;">
		  <p class="mb-3">If you would like to hear about the latest updates, enter your email down below.</p>
		  <label class="">
			  <input type="email" placeholder="Email Subscription" class="input input-bordered" />
		  </label>
...
footer {
	...
	grid-template-areas:"nav subscribe"
								      "copyright copyright";
